...
def main() :
    ...
    dataset = pd.read_csv(r"/work/u5273929/tmp_RLCD/tmp/PFFT/original_data.csv")
    dataset['text'] = dataset['output']
    ...
    print(f"[INFO]: Generated {len(written_data)} data save in {args.save_path}.")
